...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'ed7dbd93-53a2-40e0-b926-18da54445c19' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('91296f08-033a-4743-96c1-64fb228d7481');
      cy.get(`[data-cy="name"]`).should('have.value', '91296f08-033a-4743-96c1-64fb228d7481');
